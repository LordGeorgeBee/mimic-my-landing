          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="bg-white shadow-lg">
              <CardContent className="p-8">
                <p className="text-primary italic mb-6 text-lg leading-relaxed">
                ...
                <div>
                  ...
                  <p className="text-accent-light">Memorial Service</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white shadow-lg">
              <CardContent className="p-8">
                ...
                <div>
                  ...
                  <p className="text-accent-light">Celebration of Life</p>
                </div>
              </CardContent>
            </Card>
