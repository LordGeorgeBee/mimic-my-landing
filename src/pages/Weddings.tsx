    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="bg-gradient-to-b from-[#987554] to-[#E5D3B3] py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-playfair text-4xl md:text-5xl lg:text-6xl text-[#664229] text-center mb-6">
            Experience the Magic
          </h2>
          <p className="text-lg md:text-xl mb-8 text-[#664229] max-w-2xl mx-auto text-center">
            Watch Olivia perform and imagine how she could make your special day even more memorable.
          </p>
